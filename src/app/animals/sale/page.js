...
export default function Sale(){
    ...
    useEffect(() => {
        ...
        let apiUrl = 'https://gqt5g3f1h4.execute-api.eu-north-1.amazonaws.com/v1/listings?listing_type=SALE&listing_status=ACCEPTED';
            ...
            if (selectedOrder !== 'Order by' && selectedOrder !== null) {
                ...
                axios.get('https://gqt5g3f1h4.execute-api.eu-north-1.amazonaws.com/v1/ratings/user')
                    .then((response) => {
                        ...
                        if (type !== undefined) {
                        url = `https://gqt5g3f1h4.execute-api.eu-north-1.amazonaws.com/v1/listings?listing_type=SALE&animal_type=${type}&user_emails=${emailString}&listing_status=ACCEPTED`;
                        } else {
                            url = `https://gqt5g3f1h4.execute-api.eu-north-1.amazonaws.com/v1/listings?listing_type=SALE&user_emails=${emailString}&listing_status=ACCEPTED`;
                        }
        ...
        const handleFirstApiCall = () => {
            if (selectedType !== 'All Animals' && selectedType !== null) {
                apiUrl = `https://gqt5g3f1h4.execute-api.eu-north-1.amazonaws.com/v1/listings?listing_type=SALE&animal_type=${selectedType}&listing_status=ACCEPTED`;
                if (selectedOrder !== 'Order by' && selectedOrder !== null) {
